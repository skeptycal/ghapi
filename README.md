...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/ghapi/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/ghapi)
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/ghapi"
```
...
go get github.com/xxxxxx/ghapi

cd ${GOPATH}/src/github.com/xxxxxx/ghapi
...
> This is a copy of the example script available in the `cmd/example/ghapi` folder:

```go
package main

import "github.com/skeptycal/ghapi"
...
[issues]: (https://github.com/skeptycal/ghapi/issues)
[pr]: (https://github.com/skeptycal/ghapi/pulls)
